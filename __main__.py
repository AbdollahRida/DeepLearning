...
# [1]: Sirignano, Justin, and Konstantinos Spiliopoulos.
...
# Inspired from: https://github.com/alialaradi/DeepGalerkinMethod

# Import needed packages

import DGM                      # [1] modified keras LSTM
import tensorflow as tf
import numpy as np
from tqdm import tqdm
import matplotlib.pyplot as plt

import f_Call                   # fractional Black-Scholes Call
import model_utils              # Sampler and losses for the PDE

from __params__ import *        # Parameters for the PDE
...
#K_ = [60 + i for i in range(0, 100, 5)]

#for K in K_:
# loss as defined for the PDE
...
for i in tqdm(range(sampling_stages)):
